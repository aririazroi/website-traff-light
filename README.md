...
├── script.js               # Website logic + tracking
├── styles.css              # Website styles
├── articles.js             # Article data (generated or static)
├── google-apps-script.js   # Google Sheets tracking webhook
├── news_pipeline/          # Pipeline for future app
└── news_pipeline_web/      # Pipeline for website
```
...
```
Score 0 ────────── GREEN_MAX ────────── YELLOW_MAX ────────── 100
        [  GREEN  ]           [ YELLOW ]            [  RED  ]
```
...
├── script.js                     # Website JS (rendering, tracking, modal)
├── styles.css                    # Website styles
├── articles.js                   # Article data (static or generated)
├── vite.config.js                # Vite bundler config
├── package.json                  # Node dependencies
│
├── google-apps-script.js         # Google Sheets webhook code
├── GOOGLE_SHEETS_SETUP.md        # Tracking setup guide
│
├── news_pipeline/                # Pipeline for future app
│   ├── app/
│   │   ├── __init__.py
...
│   │   ├── mapping.py            # Score → color
│   │   ├── models.py             # Data models
│   │   └── scoring.py            # Scorer adapter
│   ├── output/
│   │   └── articles.json         # Generated output
│   ├── scorer.py                 # YOUR NLP scorer
│   ├── requirements.txt
│   ├── Dockerfile
│   └── README.md
│
└── news_pipeline_web/            # Pipeline for website
    ...
    │   ├── __init__.py
    │   ├── config.py
    │   ├── gnews_client.py       # + HTML formatting
    │   ├── main.py               # + sampling + JS output
    │   ├── mapping.py
    │   ├── models.py             # Website-compatible schema
